...
window.gMessageTester = {
	...
	,cssUrl: "./data/others/plugin/theme_kopanda_07/testMessagePlus/style.css"
	,sampleUrl: "./data/others/plugin/theme_kopanda_07/testMessagePlus/sampletext.ks"
...
(function(TM) {
	...
	TM.appendGlyph = function() {
		...
		this.messageArea.append('<span style="display: inline-block; width: 32px; height: 14px; background-color: ' + color + '; transform: translateY(3px);" class="img_next_test">　</span>')
	};
